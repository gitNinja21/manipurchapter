...
const env = {...process.env, ATTENDANCE_REMINDERS_ENABLED:'false', DATABASE_URL:url, JWT_SECRET:'isolated-work-rules-test-secret', UPLOADS_DIR:path.join(dir,'uploads'), RESTAURANT_LAT:'0',RESTAURANT_LNG:'0',RESTAURANT_RADIUS_METERS:'200',VAPID_PUBLIC_KEY:'',VAPID_PRIVATE_KEY:''};
